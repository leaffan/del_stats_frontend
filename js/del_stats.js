...
app.factory('svc', function ($rootScope) {
    return {
        ...
        isTeamValidForSeason: FormatUtils.isTeamValidForSeason,
        ...
        calculateAge: FormatUtils.calculateAge,
...
app.factory('triviaPageBehavior', [
    ...
    function ($http, $routeParams, svc, cfgLoader) {
        return function (ctrl, options) {
            ...
            // see FormatUtils.buildSortConfig for why the primary key is stored
            // unprefixed and every other key's direction pre-inverted
            ctrl.buildSortConfig = FormatUtils.buildSortConfig;
            ...
            ctrl.formatRecord = FormatUtils.formatRecord;
